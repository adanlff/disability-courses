...
import { Activity, LogOut, Menu, UserCircle, Settings } from "lucide-react";
...
// Dropdown menu items - berisi Activity Logs, Profile, Settings, dan Logout
            ...
            <div className="flex items-center gap-3">
              <DropdownMenu>
                ...
                >
                  ...
                  {userData && (
                    <div className="px-3 py-3 border-b border-gray-200 dark:border-gray-700">
                      ...
                      <div className="mt-1">
                        ...
                        <p className="text-gray-400 dark:text-gray-500 text-xs mt-1 capitalize">
                  ...
                  {/* Menu items: Activity Logs, Profile, Settings */}
                  <div className="py-1">
